...
<body>
            ...
            @if(Auth::user()->role=='admin')
                @if(!empty($checkernav))
                    @if($checkernav==1)
                        ...
                        <li>
                            <a href="{{ url('/suratmasuk') }}"><i class="fa fa-fw fa-file-text"></i> Surat Masuk</a>
                        </li>
                        <li>
                            <a href="{{ url('/suratkeluar') }}"><i class="fa fa-fw fa-file-text-o"></i> Surat Keluar</a>
                        </li>
                         <li>
                            <a href="{{ url('/disposisi') }}"><i class="fa fa-fw fa fa-file-o"></i> Disposisi</a>
                        </li>
                    @elseif($checkernav==2)
                       <li>
                            <a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
  ...
  <!--  <footer id="footer">
        <div class="container">
            <div class="row">
                <div align="right">
                    &copy; 2017 Aplikasi Pengarsipan Surat.
                </div>
            </div>
        </div>
    </footer> -->
